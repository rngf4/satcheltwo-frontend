...
function SignIn() {
    return (<NavigationItem item={{ href: "/signin", name: "Sign In", private: false }} />)
}
                ...
                <>
                    ...
                    <Disclosure.Panel className="sm:hidden">
                        <div className="space-y-1 px-2 pt-2 pb-3">
                            ...
                            >
                                {({ isActive }) => (
                                    <div className={classNames(isActive ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'block px-3 py-2 rounded-md text-base font-medium')}>
                                        {item.name}
                                    </div>
                                )}
                            </NavLink>))}
